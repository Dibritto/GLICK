      ...
      <div className="flex items-center h-full px-2 gap-2 md:gap-4 overflow-visible">
        ...
        <Tooltip text="Soma de todos os saldos em contas e investimentos." position="bottom">
          <div className="flex items-center gap-2 whitespace-nowrap cursor-help group">
            ...
            <span className="hidden xl:inline text-[10px] uppercase tracking-wider text-gray-400 font-bold">Saldo Total:</span>
        ...
        <Tooltip text="Total de entradas confirmadas e previstas para o mês atual." position="bottom">
          <div className="flex items-center gap-2 whitespace-nowrap cursor-help group">
            ...
            <span className="hidden xl:inline text-[10px] uppercase tracking-wider text-gray-400 font-bold">Receitas:</span>
        ...
        <Tooltip text="Total de saídas confirmadas e previstas para o mês atual." position="bottom">
          <div className="flex items-center gap-2 whitespace-nowrap cursor-help group">
            ...
            <span className="hidden xl:inline text-[10px] uppercase tracking-wider text-gray-400 font-bold">Despesas:</span>
        ...
        <Tooltip text="Estimativa de saldo ao final do mês (Saldo + Receitas - Despesas)." position="bottom">
          <div className="flex items-center gap-2 whitespace-nowrap cursor-help group">
            ...
            <span className="hidden xl:inline text-[10px] uppercase tracking-wider text-gray-400 font-bold">Projetado:</span>
        ...
        <Tooltip text="Valor disponível após subtrair despesas comprometidas e reservas." position="bottom">
          <div className="flex items-center gap-2 whitespace-nowrap cursor-help group">
            ...
            <span className="hidden xl:inline text-[10px] uppercase tracking-wider text-gray-400 font-bold">Livre:</span>
