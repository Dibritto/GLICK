  ...
  return (
    <header className="h-11 flex-shrink-0 bg-brand-graphite border-b border-brand-lead/20 relative z-50 overflow-visible">
      <div className="flex items-center h-full px-2 gap-2 md:gap-4 overflow-visible">
        ...
        <div className="hidden lg:block h-4 w-[1px] bg-brand-lead/50 shrink-0" />
        ...
        <Tooltip text="Estimativa de saldo ao final do mês (Saldo + Receitas - Despesas)." position="bottom">
          <div className="flex items-center gap-1.5 whitespace-nowrap cursor-help group">
            <Activity size={14} className="text-brand-orange/70 group-hover:text-brand-orange transition-colors" />
        ...
        <Tooltip text="Valor disponível após subtrair despesas comprometidas e reservas." position="bottom">
          <div className="flex items-center gap-1.5 whitespace-nowrap cursor-help group">
            <Target size={14} className="text-brand-green/70 group-hover:text-brand-green transition-colors" />
