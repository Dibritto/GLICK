      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            <Bitcoin className="text-brand-blue" />
            Criptoativos
          </h1>
          <p className="text-gray-400 text-sm">Gerencie seu portfólio de criptomoedas</p>
        </div>
        <button
          onClick={() => setIsModalOpen(true)}
          className="flex items-center gap-2 px-4 py-2 bg-brand-blue/20 text-brand-blue rounded-lg hover:bg-brand-blue/30 transition-colors"
        >
          <Plus size={18} />
          Nova Transação
        </button>
